...
define('HTTP_TEMPLATE', $protocol . $_SERVER['HTTP_HOST'] . rtrim(dirname($_SERVER['SCRIPT_NAME']), '/.\\') . '/');

# DIRECTORY SEPARATOR
define('DS', DIRECTORY_SEPARATOR);

# ROOT DIR
define('DIR_ROOT', realpath(dirname(__FILE__)) . DS);

# DIR
define('DIR_APPLICATION', DIR_ROOT . 'template' . DS);
