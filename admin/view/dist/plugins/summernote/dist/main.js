    			...
    			image: function() {
					...
					var button = ui.button({
						...
						click: function () {
							...
							$.ajax({
								url: 'index.php?url=common/filemanager&user_token=' + getURLVar('user_token'),
								dataType: 'html',
								beforeSend: function() {
								...
								success: function(html) {
									...
									$('#modal-image').delegate('#save-image', 'click', function(e) {
                                        e.preventDefault();
										
                                        $(element).summernote('insertImage', $('span.thumbnail').find('img').attr('src'));
