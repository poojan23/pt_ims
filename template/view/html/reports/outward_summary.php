            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="">
                                <canvas id="outwardSummary"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
        var canvas = document.getElementById('outwardSummary');
...
<?php echo $sheet; ?>
        ...
        var ctx = document.getElementById("outwardSummary").getContext('2d');
...
function parseSVG(s) {
         ...
         function thickpdf() {
                    ...
                    var source = $('#reportPage1')[0];
                   var hdndate = $('#hdnid').val();
                        ...
                        html2canvas(source, {
                            ...
                            onrendered: function (canvas) {
                                ...
                                if (canvas.width > canvas.height) {
                                    ...
                                    //pdf.canvas.height = pdf.internal.pageSize.height;
                                    //pdf.canvas.width = pdf.internal.pageSize.width;
                                    
                                    var file = pdf.save('DirectorReport_Leo'+hdndate + '.pdf');
