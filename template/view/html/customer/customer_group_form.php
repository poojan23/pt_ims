                                            ...
                                            <div class="col-sm-10">
                                                <?php foreach ($languages as $language) : ?>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="customer_group_description[<?php echo $language['language_id']; ?>][name]" placeholder="<?php echo $entry_name; ?>" value="<?php echo isset($customer_group_description[$language['language_id']]) ? $customer_group_description[$language['language_id']]['name'] : ''; ?>" id="input-name">
                                                    </div>
