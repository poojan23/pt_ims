            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger btn-bold" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer-group').submit() : false;"><i class="fa fa-trash-o"></i></button>
                    </div>
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="table-customer">
                            <thead>
                                <tr>
...
<script>
                            $(document).ready(function () {
                                var table = $('#table-customer').DataTable({
                                    ...
                                    'ajax': {
                                        url: 'index.php?url=customer/customer_group/getData&member_token=' + getURLVar('member_token'),
                                        dataType: 'json',
                                        type: 'POST',
                                    ...
                                    "columns": [
                                        ...
                                        { 
                                            data: function(data, type, row) {
                                                if(type === 'display') {
                                                    return '<a href="<?php echo $edit; ?>&customer_group_id=' + data.customer_group_id + '" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a>';
                                                }
                                              return data;
                                            },
                                            "bSearchable": false,
