            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="<?php echo $delete; ?>" method="POST" enctype="multipart/form-data" id="form-customer">
                        ...
                        <div>
                            <table id="table-zone" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th style="width: 1px;" class="center">
                                            <?php echo $column_no; ?>
                                        </th>
                                        <th><?php echo $column_country; ?></th>
                                        <th><?php echo $column_name; ?></th>
                                        <th><?php echo $column_zone_code; ?></th>
    ...
    jQuery(function ($) {
        ...
        var myTable =
                ...
                .DataTable({
                    ...
                    "aoColumns": [
                        ...
                        {data: 'code'},
                                /*{ 
                                 ...
                                 if(type === 'display') {
                                 return '<a href="<?php echo $edit; ?>&zone_id=' + data.zone_id + '" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a>';
                                 }
                                 return data;
                                 },
                                 "bSearchable": false,
                    ...
                    "bProcessing": true,
                    //"bServerSide": true,
                    "sAjaxSource": "index.php?url=localisation/zone/getData&member_token=" + getURLVar('member_token'),
