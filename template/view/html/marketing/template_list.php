            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="<?php echo $delete; ?>" method="POST" enctype="multipart/form-data" id="form-user-group">
                                ...
                                <div>
                                    <table id="table-template" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
...
jQuery(function($) {
    ...
    .DataTable( {
        ...
        "aoColumns": [
            ...
            { 
                data: function(data, type, row) {
                    if(type === 'display') {
                        return '<a href="<?php echo $edit; ?>&template_id=' + data.template_id + '" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a>';
                    }
                  return data;
                },
                "bSearchable": false,
        ...
        "bProcessing": true,
        //"bServerSide": true,
        "sAjaxSource": "index.php?url=marketing/template/getData&member_token=" + getURLVar('member_token'),
