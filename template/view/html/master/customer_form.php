                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form method="get" class="form-horizontal">
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label"><?= $label_address1; ?></label>
                                            <div class="col-sm-10"><textarea class="form-control" placeholder="<?= $entry_address1; ?>"></textarea></div>
                                        </div>
                                        <div class="hr-line-dashed"></div>

                                        <div class="form-group"><label class="col-sm-2 control-label"><?= $label_address2; ?></label>
                                            <div class="col-sm-10"><textarea class="form-control" placeholder="<?= $entry_address2; ?>"></textarea></div>
                                        </div>
                                        <div class="hr-line-dashed"></div>

                                        <div class="form-group"><label class="col-sm-2 control-label"><?= $label_pincode; ?></label>
                                            <div class="col-sm-10"><input type="number" class="form-control" placeholder="<?= $entry_pincode; ?>"></div>
                                        </div>
                                        <div class="hr-line-dashed"></div>

                                        <div class="form-group"><label class="col-sm-2 control-label"><?= $label_gst_no; ?></label>
                                            <div class="col-sm-10"><input type="number" class="form-control" placeholder="<?= $entry_gst_no; ?>"></div>
                                        </div>
                                        <div class="hr-line-dashed"></div>

                                        <div class="form-group"><label class="col-sm-2 control-label"><?= $label_email; ?></label>
                                            <div class="col-sm-10"><input type="text" class="form-control" placeholder="<?= $entry_email; ?>"></div>
                                        </div>
