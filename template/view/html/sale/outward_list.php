            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-example" id="table-outward">
                            <thead>
                                <tr>
...
<script>
                            $(document).ready(function () {
                                var table = $('#table-outward').DataTable({
                                    pageLength: 10,
                                    responsive: true,
                                    ...
                                    'ajax': {
                                        url: 'index.php?url=sale/outward/getData&member_token=' + getURLVar('member_token'),
                                        dataType: 'json',
                                        type: 'POST',
                                    },
                                    "columns": [
                                        ...
                                        },
                                        {
                                            data: function (data, type, row) {
                                                if (type === 'display') {
                                                    return '<a href="<?php echo $edit; ?>&delivery_id=' + data.delivery_id + '" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></a>';
                                                }
                                                return data;
                                            },
                                            "bSearchable": false,
