...
class ModelCustomerCustomerGroup extends Model
{
    public function addCustomerGroup($data) {
        $this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET sort_order = '" . (int)$data['sort_order'] . "'");
    ...
    public function getCustomerGroupByName($name) {
        $query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "customer_group_description WHERE name = '" . $this->db->escape($name) . "'");
